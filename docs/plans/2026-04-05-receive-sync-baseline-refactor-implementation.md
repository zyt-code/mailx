...
- `mailboxStore.test.ts` now also covers unrelated `account:updated` events so editing another account does not reload the current mailbox
...
- focused frontend regression suite now passes at 36 files / 159 tests
